        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Postcode = table.Column<string>(type: "nvarchar(12)", maxLength: 12, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PL_Number = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineAttribution", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicineAttribution_Medicine_MedicineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicineAttribution_MedicineId",
                table: "MedicineAttribution",
                column: "MedicineId");
        }
